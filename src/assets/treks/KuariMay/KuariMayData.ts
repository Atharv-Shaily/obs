...
import kuariMayBrochure from './Brochure - Kuari Pass (Oh Bhaisahab Experience).pdf'
import type { TrekData } from '../TrekData';

export const kuariMayData: TrekData = {
  id: 'kuari-may',
  ...
  cancellationPolicy: [
    ...
    {
      period: '12 May – 20 May',
      fee: '50% of total fee',
      refund: '50%',
    },
    {
      period: 'On or after 20 May',
      fee: '100%',
